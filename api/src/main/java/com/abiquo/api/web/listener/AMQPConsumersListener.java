...
import com.abiquo.api.eventing.EventingProcessor;
...
/**
 * Manage the life cycle of the AMQP listeners.
 * 
 * @author eruiz@abiquo.com
 */
public class AMQPConsumersListener implements ServletContextListener
{
    public static final Logger LOGGER = LoggerFactory.getLogger(AMQPConsumersListener.class);
    ...
    public void contextInitialized(ServletContextEvent sce)
    {
        ...
        try
        {
            LOGGER.info("Initializing context " + contextName + " ...");
            initializeEventsConsumer(sce);
            LOGGER.info("Context " + contextName + " has been initialized");
        }
        catch (IOException e)
        {
            LOGGER.error("An error occurred while initializing context " + contextName, e);
        }
    }
    ...
    public void contextDestroyed(ServletContextEvent sce)
    {
        ...
        try
        {
            LOGGER.info("Destroying context " + contextName + " ...");
            shutdownEventsConsumer();
            LOGGER.info("Context " + contextName + " has been destroyed");
        }
        catch (IOException e)
        {
            LOGGER.error("An error occurred while destroying context " + contextName, e);
        }
    }
